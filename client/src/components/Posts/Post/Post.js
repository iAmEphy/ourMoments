...
const Post = ({ post, setCurrentId }) => {
  ...
  return (
    //Card. Cardmedia is image.
    //fromNow how long ago from posted date
    
    //line 32. 3 dots. edit button copy info to the form to edit
    <Card className={classes.card}>
      ...
      <div className={classes.overlay2}>
        <Button style={{ color: 'white' }} 
          size="small" 
          onClick={() => setCurrentId(post._id)}><MoreHorizIcon 
      ...
      <CardActions className={classes.cardActions}>
        <Button 
            size="small" 
            color="primary" 
            onClick={() => dispatch(likePost(post._id))}><ThumbUpAltIcon 
